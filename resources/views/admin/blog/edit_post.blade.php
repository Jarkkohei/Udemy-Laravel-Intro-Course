        ...
        <form action="{{ route('admin.blog.post.update') }}" method="post">
            ...
            <div class="input-group">
                ...
                <input type="text" name="author" id="author" 
                    {{ $errors->has('author') ? 'class=has-error' : '' }} 
            ...
            <div class="input-group">
                ...
                <select name="category_select" id="category_select">
                    <!-- Foreach loop to output our categories -->
            ...
            <div class="input-group">
                ...
                <textarea name="body" id="body" rows="12" 
                    {{ $errors->has('body') ? 'class=has-error' : '' }}>
                    {{ Request::old('body') ? Request::old('body') : isset($post) ? $post->body : '' }}</textarea>
            </div>
